<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<ul class="first acfb-holder">
		<li>
			...
			<input type="text" name="send-to-input" class="send-to-input send-message-input" id="send-to-input" />
		</li>
	</ul>
	...
	<input type="text" name="subject" id="subject" class="send-message-input" value="<?php bp_messages_subject_value(); ?>" />

	<label for="content"><?php _e( 'Message', 'buddypress'); ?></label>
	<textarea name="content" id="message_content" rows="15" cols="40" class="send-message-input"><?php bp_messages_content_value(); ?></textarea>

	<input type="hidden" name="send_to_usernames" id="send-to-usernames" class="send-message-input" value="<?php bp_message_get_recipient_usernames(); ?>" class="<?php bp_message_get_recipient_usernames(); ?>" />
